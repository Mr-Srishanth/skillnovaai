...
const AnalyzePanel = ({ userId }: { userId: string }) => {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="glass-card box-glow-cyan space-y-6 mb-8">
        <div>
      ...
      <AnimatePresence>
        {loading && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="glass-card mb-8 text-center space-y-4"
          >
      ...
      {result && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          ...
          {/* Next Best Step */}
          <div className="glass-card border-primary/30 box-glow-cyan">
          ...
          {/* Missing Skills */}
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="glass-card box-glow-cyan">
            ...
            <div className="space-y-3">
              {result.missingSkills.map((item, i) => (
                <motion.div
                  ...
                  className="flex flex-col sm:flex-row sm:items-center gap-2 p-3 rounded-xl bg-muted/20 border border-border/30"
                >
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }} className="glass-card box-glow-purple">
          ...
          {/* Roadmap */}
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="glass-card box-glow-cyan">
          ...
          {result.weeklyPlan?.length > 0 && (
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }} className="glass-card box-glow-purple">
          ...
          {result.scoreImpactTips?.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card box-glow-cyan">
